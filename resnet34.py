...
class ResNet18:
    def __init__(self, ResNet_npy_path="weight/resnet34.npz", trainable=True, open_tensorboard=False):
        """
        Initialize function
    ...
    def build(self, rgb, label_num=1200, last_layer_type="softmax"):
        ...
        self.block1_3 = self.res_block_3_layers(self.block1_2, [64, 64], "block1_3")

        self.block2_1 = self.res_block_3_layers(self.block1_3, [128, 128], "block2_1", True, 2)
        self.block2_2 = self.res_block_3_layers(self.block2_1, [128, 128], "block2_2")
        self.block2_3 = self.res_block_3_layers(self.block2_2, [128, 128], "block2_3")
        self.block2_4 = self.res_block_3_layers(self.block2_3, [128, 128], "block2_4")

        self.block3_1 = self.res_block_3_layers(self.block2_4, [256, 256], "block3_1", True, 2)
        self.block3_2 = self.res_block_3_layers(self.block3_1, [256, 256], "block3_2")
        self.block3_3 = self.res_block_3_layers(self.block3_2, [256, 256], "block3_3")
        self.block3_4 = self.res_block_3_layers(self.block3_3, [256, 256], "block3_4")
        self.block3_5 = self.res_block_3_layers(self.block3_4, [256, 256], "block3_5")
        self.block3_6 = self.res_block_3_layers(self.block3_5, [256, 256], "block3_6")

        self.block4_1 = self.res_block_3_layers(self.block3_6, [512, 512], "block4_1", True, 2)
        self.block4_2 = self.res_block_3_layers(self.block4_1, [512, 512], "block4_2")
        self.block4_3 = self.res_block_3_layers(self.block4_2, [512, 512], "block4_3")
