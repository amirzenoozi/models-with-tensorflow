...
class ResNet:
    def __init__(self, ResNet_npy_path="weight/resnet101.npy", trainable=True, open_tensorboard=False):
        """
        Initialize function
    ...
    def build(self, rgb, label_num=1200, last_layer_type="softmax"):
        ...
        self.block4_1 = self.res_block_3_layers(self.block3_23, [512, 512, 2048], "block4_1", True, 2)
